...
public:
     ...
     *
     * @param   uint8_t    r       The red color value
     * @param   uint8_t    g       The green color value
     * @param   uint8_t    b       The blue color value
     * @param   double  hsl[]   The HSL representation
     */
    void rgbToHsl(uint8_t r, uint8_t g, uint8_t b, double hsl[]);
     ...
     * @return  uint8_t    rgb[]   The RGB representation
     */
