 ...
 */
void RGBConverter::rgbToHsl(uint8_t r, uint8_t g, uint8_t b, double hsl[]) { 
 ...
 */
void RGBConverter::hslToRgb(double h, double s, double l, uint8_t rgb[]) {
    double r, g, b;
 ...
 */
void RGBConverter::rgbToHsv(uint8_t r, uint8_t g, uint8_t b, double hsv[]) {
    double rd = (double) r/255;
    double gd = (double) g/255;
    double bd = (double) b/255;
 ...
 * @return  Array           The RGB representation
 */
void RGBConverter::hsvToRgb(double h, double s, double v, uint8_t rgb[]) {
    double r, g, b;
